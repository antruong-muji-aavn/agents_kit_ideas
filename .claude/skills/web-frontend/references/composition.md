...
klara-theme uses the compound component pattern extensively:
...
klara-theme enforces this with `cva()` (class-variance-authority):
...
Reference layout patterns in `app/[locale]/(auth)/layout.tsx`.
