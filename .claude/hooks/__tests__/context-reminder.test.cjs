 ...
 * Run: node --test .claude/hooks/__tests__/context-reminder.test.cjs
 *
...
const HOOK_PATH = path.join(__dirname, '..', 'context-reminder.cjs');

/**
 * Execute context-reminder.cjs with given stdin data and return stdout
